package app.nexusforms.collect.audiorecorder.recording.internal
...
import app.nexusforms.audiorecorder.recording.internal.ReturnToAppActivity
...
class AudioRecorderServiceTest {
    ...
    fun startAction_startsInForegroundWithNotification() {
        ...
        assertThat(shadowOf(notification.contentIntent).savedIntent.component?.className, equalTo(
            ReturnToAppActivity::class.qualifiedName))
    }
