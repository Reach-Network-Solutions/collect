...
class AudioClipViewModelTest {
    ...
    private var viewModel: AudioClipViewModel =
        AudioClipViewModel(Supplier { mediaPlayer }, fakeScheduler)
    ...
    fun play_afterBackground_createsANewMediaPlayer() {
        val factory =
            RecordingMockMediaPlayerFactory()
