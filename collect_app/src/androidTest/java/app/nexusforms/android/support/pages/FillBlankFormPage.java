...
public class FillBlankFormPage extends Page<FillBlankFormPage> {
    ...
    public FillBlankFormPage checkIsFormSubtextDisplayed() {
        onView(CustomMatchers.withIndex(withId(R.id.form_subtitle2), 0)).check(matches(isDisplayed()));
        return this;
    }

    public FillBlankFormPage checkMapIconDisplayedForForm(String formName) {
        onData(AllOf.allOf(is(instanceOf(Cursor.class)), CursorMatchers.withRowString(FormsProviderAPI.FormsColumns.DISPLAY_NAME, is(formName))))
    ...
    public FillBlankFormPage assertFormExists(String formName) {
        ...
        return waitFor(() -> {
            ...
            onData(CursorMatchers.withRowString(FormsProviderAPI.FormsColumns.DISPLAY_NAME, formName)).check(matches(isDisplayed()));
            return this;
        });
    }
