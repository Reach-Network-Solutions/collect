...
import app.nexusforms.android.support.actions.RotateAction;
import app.nexusforms.android.support.matchers.RecyclerViewMatcher;
import app.nexusforms.android.support.matchers.ToastMatcher;
...
import static app.nexusforms.android.support.CustomMatchers.withIndex;
...
abstract class Page<T extends Page<T>> {
    ...
    public T scrollToAndClickText(int text) {
        onView(withText(getTranslatedString(text))).perform(NestedScrollToAction.nestedScrollTo(), click());
        return (T) this;
    }

    public T scrollToAndClickText(String text) {
        onView(withText(text)).perform(NestedScrollToAction.nestedScrollTo(), click());
        return (T) this;
    }
    ...
    public T scrollToAndAssertText(String text) {
        onView(withText(text)).perform(NestedScrollToAction.nestedScrollTo());
