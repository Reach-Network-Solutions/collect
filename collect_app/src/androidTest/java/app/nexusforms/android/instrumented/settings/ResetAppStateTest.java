...
package app.nexusforms.android.instrumented.settings;
...
public class ResetAppStateTest {
    ...
    public void resetSettingsTest() throws IOException {
        ...
        Assert.assertEquals("", webCredentialsUtils.getCredentials(URI.create("https://demo.getodk.org")).getUsername());
        Assert.assertEquals("", webCredentialsUtils.getCredentials(URI.create("https://demo.getodk.org")).getPassword());
    }
    ...
    private void setupTestFormsDatabase() {
        ...
        values.put(FormsProviderAPI.FormsColumns.JRCACHE_FILE_PATH, storagePathProvider.getRelativeCachePath("3a76a386464925b6f3e53422673dfe3c.formdef"));
        values.put(FormsProviderAPI.FormsColumns.JR_FORM_ID, "jrFormId");
        values.put(FormsProviderAPI.FormsColumns.FORM_MEDIA_PATH, storagePathProvider.getRelativeFormPath("testFile1-media"));
        ...
        values.put(FormsProviderAPI.FormsColumns.FORM_FILE_PATH, storagePathProvider.getRelativeFormPath("testFile1.xml"));
