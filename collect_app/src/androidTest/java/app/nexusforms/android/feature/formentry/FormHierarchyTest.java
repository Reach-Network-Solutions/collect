...
import app.nexusforms.android.support.pages.AddNewRepeatDialog;
import app.nexusforms.android.support.pages.FormEntryPage;
import app.nexusforms.android.support.pages.FormHierarchyPage;
...
public class FormHierarchyTest {
    ...
    public void allRelevantQuestionsShouldBeVisibleInHierarchyView() {
        ...
        onView(RecyclerViewMatcher.withRecyclerView(R.id.list)
