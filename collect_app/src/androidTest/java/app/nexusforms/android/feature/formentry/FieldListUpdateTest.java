...
import app.nexusforms.android.preferences.GuidanceHint;
...
import app.nexusforms.android.support.actions.NestedScrollToAction;
...
public class FieldListUpdateTest {
    ...
    public void relevanceChangeAtEnd_ShouldToggleLastWidgetVisibility() {
        ...
        onView(CustomMatchers.withIndex(withClassName(endsWith("EditText")), 0)).perform(replaceText(""));
        onView(withText("Target1")).check(doesNotExist());
        onView(CustomMatchers.withIndex(withClassName(endsWith("EditText")), 0)).perform(replaceText("A"));
    ...
    public void relevanceChangeAtBeginning_ShouldToggleFirstWidgetVisibility() {
        ...
        onView(CustomMatchers.withIndex(withClassName(endsWith("EditText")), 1)).perform(replaceText(""));
        onView(withText("Target2")).check(doesNotExist());
    }
    ...
    public void longPress_ShouldClearAndUpdate() {
        ...
        onView(CustomMatchers.withIndex(withClassName(endsWith("EditText")), 0)).check(matches(withText("")));
        onView(withText("Target3")).check(doesNotExist());
    }
    ...
    public void changeInValueUsedInLabel_ShouldChangeLabelText() {
        ...
        onView(CustomMatchers.withIndex(withClassName(endsWith("EditText")), 1)).perform(replaceText(name));
    ...
    public void changeInValueUsedInHint_ShouldChangeHintText() {
        ...
        onView(CustomMatchers.withIndex(withClassName(endsWith("EditText")), 0)).perform(replaceText(name));
    ...
    public void changeInValueUsedInOtherField_ShouldChangeValue() {
        ...
        onView(CustomMatchers.withIndex(withClassName(endsWith("EditText")), 0)).perform(replaceText(""));
        onView(CustomMatchers.withIndex(withClassName(endsWith("EditText")), 1)).check(matches(withText("0")));
        onView(CustomMatchers.withIndex(withClassName(endsWith("EditText")), 2)).check(matches(withText("")));
        onView(CustomMatchers.withIndex(withClassName(endsWith("EditText")), 0)).perform(replaceText(name));
        onView(CustomMatchers.withIndex(withClassName(endsWith("EditText")), 1)).check(matches(withText(String.valueOf(name.length()))));
        onView(CustomMatchers.withIndex(withClassName(endsWith("EditText")), 2)).check(matches(withText(String.valueOf(name.charAt(0)))));
        onView(CustomMatchers.withIndex(withClassName(endsWith("EditText")), 0)).perform(replaceText(""));
        onView(CustomMatchers.withIndex(withClassName(endsWith("EditText")), 1)).check(matches(withText("0")));
        onView(CustomMatchers.withIndex(withClassName(endsWith("EditText")), 2)).check(matches(withText("")));
    }
    ...
    public void selectionChangeAtFirstCascadeLevel_ShouldUpdateNextLevels() {
        ...
        onView(withText("A1A")).perform(NestedScrollToAction.nestedScrollTo());
    ...
    public void clearingParentSelect_ShouldUpdateAllDependentLevels() {
        ...
        onView(withText("A1")).perform(NestedScrollToAction.nestedScrollTo(), click());
        onView(withText("A1B")).perform(NestedScrollToAction.nestedScrollTo(), click());

        onView(withText("Level1")).perform(NestedScrollToAction.nestedScrollTo(), longClick());
        onView(withText(R.string.clear_answer)).perform(click());
        onView(withText(R.string.discard_answer)).perform(click());
    ...
    public void questionsAppearingBeforeCurrentTextQuestion_ShouldNotChangeFocus() {
        ...
        onView(CustomMatchers.withIndex(withClassName(endsWith("EditText")), 15)).check(matches(isCompletelyDisplayed()));
        onView(CustomMatchers.withIndex(withClassName(endsWith("EditText")), 15)).check(matches(hasFocus()));
    }
    ...
    public void changeInValueUsedInGuidanceHint_ShouldChangeGuidanceHintText() {
        ...
        onView(CustomMatchers.withIndex(withClassName(endsWith("EditText")), 0)).perform(replaceText("5"));
