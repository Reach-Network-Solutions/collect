...
import app.nexusforms.android.support.FormActivityTestRule;
...
public class AllWidgetsFormTest {
    ...
    public FormActivityTestRule activityTestRule = new FormActivityTestRule(FormLoadingUtils.ALL_WIDGETS_FORM);
    ...
    public RuleChain copyFormChain = RuleChain
            ...
            .around(new CopyFormRule(FormLoadingUtils.ALL_WIDGETS_FORM))
