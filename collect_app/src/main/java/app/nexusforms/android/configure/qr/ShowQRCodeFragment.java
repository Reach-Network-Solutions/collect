...
public class ShowQRCodeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        passwordsSet[0] = !settingsProvider.getAdminSettings().getString(AdminKeys.KEY_ADMIN_PW).isEmpty();
        passwordsSet[1] = !settingsProvider.getGeneralSettings().getString(GeneralKeys.KEY_PASSWORD).isEmpty();
