...
public class FormsDatabaseHelper extends SQLiteOpenHelper {
    ...
    public FormsDatabaseHelper(DatabaseMigrator databaseMigrator, StoragePathProvider storagePathProvider) {
        super(new DatabaseContext(storagePathProvider.getOdkDirPath(StorageSubdirectory.METADATA)), DatabaseConstants.FORMS_DATABASE_NAME, null, DatabaseConstants.FORMS_DATABASE_VERSION);
