...
public class InstancesDatabaseHelper extends SQLiteOpenHelper {
    ...
    public InstancesDatabaseHelper(DatabaseMigrator databaseMigrator, StoragePathProvider storagePathProvider) {
        super(new DatabaseContext(storagePathProvider.getOdkDirPath(StorageSubdirectory.METADATA)), DatabaseConstants.INSTANCES_DATABASE_NAME, null, DatabaseConstants.INSTANCES_DATABASE_VERSION);
