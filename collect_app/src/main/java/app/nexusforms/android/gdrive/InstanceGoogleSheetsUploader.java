...
import app.nexusforms.android.exception.BadUrlException;
import app.nexusforms.android.exception.MultipleFoldersFoundException;
import app.nexusforms.android.gdrive.sheets.DriveApi;
import app.nexusforms.android.gdrive.sheets.DriveHelper;
import app.nexusforms.android.gdrive.sheets.SheetsApi;
import app.nexusforms.android.gdrive.sheets.SheetsHelper;
...
import app.nexusforms.android.utilities.UrlUtils;
...
public class InstanceGoogleSheetsUploader extends InstanceUploader {
    ...
    private String getInstanceID(List<TreeElement> elements) {
        for (TreeElement element : elements) {
            if (element.getName().equals(FormController.INSTANCE_ID)) {
