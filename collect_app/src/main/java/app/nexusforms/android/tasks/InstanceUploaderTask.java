...
import app.nexusforms.android.listeners.InstanceUploaderListener;
            ...
            if (outcome != null && stateListener != null) {
                if (outcome.authRequestingServer != null) {
                    ...
                    Stream<Instance> instancesToDelete = instanceIds.stream()
                            ...
                            .filter(instance -> InstanceUploaderUtils.shouldFormBeDeleted(formsRepository, instance.getJrFormId(), instance.getJrVersion(), isFormAutoDeleteOptionEnabled));
