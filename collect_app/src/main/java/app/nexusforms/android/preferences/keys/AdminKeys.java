package app.nexusforms.android.preferences.keys;
...
public final class AdminKeys {
    ...
    public static AdminAndGeneralKeys[] adminToGeneral = {
            AdminAndGeneralKeys.ag(KEY_CHANGE_SERVER,              GeneralKeys.KEY_PROTOCOL),
            AdminAndGeneralKeys.ag(KEY_CHANGE_FORM_METADATA,       GeneralKeys.KEY_FORM_METADATA),

            AdminAndGeneralKeys.ag(KEY_PERIODIC_FORM_UPDATES_CHECK, GeneralKeys.KEY_PERIODIC_FORM_UPDATES_CHECK),
            AdminAndGeneralKeys.ag(KEY_AUTOMATIC_UPDATE,           GeneralKeys.KEY_AUTOMATIC_UPDATE),
            AdminAndGeneralKeys.ag(KEY_HIDE_OLD_FORM_VERSIONS,     GeneralKeys.KEY_HIDE_OLD_FORM_VERSIONS),
            AdminAndGeneralKeys.ag(KEY_CHANGE_FONT_SIZE,           GeneralKeys.KEY_FONT_SIZE),
            AdminAndGeneralKeys.ag(KEY_APP_LANGUAGE,               GeneralKeys.KEY_APP_LANGUAGE),
            AdminAndGeneralKeys.ag(KEY_DEFAULT_TO_FINALIZED,       GeneralKeys.KEY_COMPLETED_DEFAULT),
            AdminAndGeneralKeys.ag(KEY_HIGH_RESOLUTION,            GeneralKeys.KEY_HIGH_RESOLUTION),
            AdminAndGeneralKeys.ag(KEY_IMAGE_SIZE,                 GeneralKeys.KEY_IMAGE_SIZE),
            AdminAndGeneralKeys.ag(KEY_GUIDANCE_HINT,              GeneralKeys.KEY_GUIDANCE_HINT),
            AdminAndGeneralKeys.ag(KEY_SHOW_SPLASH_SCREEN,         GeneralKeys.KEY_SHOW_SPLASH),
            AdminAndGeneralKeys.ag(KEY_SHOW_SPLASH_SCREEN,         GeneralKeys.KEY_SPLASH_PATH),
            AdminAndGeneralKeys.ag(KEY_DELETE_AFTER_SEND,          GeneralKeys.KEY_DELETE_AFTER_SEND),
            AdminAndGeneralKeys.ag(KEY_INSTANCE_FORM_SYNC,         GeneralKeys.KEY_INSTANCE_SYNC),
            AdminAndGeneralKeys.ag(KEY_APP_THEME,                  GeneralKeys.KEY_APP_THEME),

            AdminAndGeneralKeys.ag(KEY_AUTOSEND,                   GeneralKeys.KEY_AUTOSEND),

            AdminAndGeneralKeys.ag(KEY_NAVIGATION,                 GeneralKeys.KEY_NAVIGATION),
            AdminAndGeneralKeys.ag(KEY_CONSTRAINT_BEHAVIOR,        GeneralKeys.KEY_CONSTRAINT_BEHAVIOR),

            AdminAndGeneralKeys.ag(KEY_ANALYTICS,                  GeneralKeys.KEY_ANALYTICS),
            AdminAndGeneralKeys.ag(KEY_FORM_UPDATE_MODE,           GeneralKeys.KEY_FORM_UPDATE_MODE),
            AdminAndGeneralKeys.ag(KEY_EXTERNAL_APP_RECORDING,     GeneralKeys.KEY_EXTERNAL_APP_RECORDING)
    };
