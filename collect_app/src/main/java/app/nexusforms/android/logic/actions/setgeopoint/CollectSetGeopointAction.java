...
package app.nexusforms.android.logic.actions.setgeopoint;
...
import app.nexusforms.android.location.client.MaxAccuracyWithinTimeoutLocationClient;
...
public class CollectSetGeopointAction extends SetGeopointAction implements LocationListener {
    ...
    public void requestLocationUpdates() {
        ...
        if (generalSettings.getBoolean(GeneralKeys.KEY_BACKGROUND_LOCATION)
