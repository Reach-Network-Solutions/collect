...
package app.nexusforms.android.logic;
...
public class PropertyManager implements IPropertyManager {
    ...
    public PropertyManager reload() {
        ...
        initUserDefined(generalSettings, GeneralKeys.KEY_METADATA_USERNAME,    PROPMGR_USERNAME,      SCHEME_USERNAME);
        initUserDefined(generalSettings, GeneralKeys.KEY_METADATA_PHONENUMBER, PROPMGR_PHONE_NUMBER,  SCHEME_TEL);
        initUserDefined(generalSettings, GeneralKeys.KEY_METADATA_EMAIL,       PROPMGR_EMAIL,         SCHEME_MAILTO);
        ...
        if (getSingularProperty(PROPMGR_USERNAME) == null || getSingularProperty(PROPMGR_USERNAME).isEmpty()) {
            putProperty(PROPMGR_USERNAME, SCHEME_USERNAME, settingsProvider.getGeneralSettings().getString(GeneralKeys.KEY_USERNAME));
        }
