...
public class OSMWidget extends QuestionWidget implements WidgetDataReceiver, ButtonClickListener {
    ...
    public OSMWidget(Context context, QuestionDetails questionDetails, WaitingForDataRegistry waitingForDataRegistry) {
        ...
        osmFileNameHeaderTextView.setId(generateViewId());
        ...
        osmFileNameTextView.setId(generateViewId());
        ...
        if (osmFileName != null) {
            ...
            osmFileNameHeaderTextView.setVisibility(GONE);
        }
    ...
    private void launchOpenMapKit() {
        try {
            ...
            try {
                ...
                ((Activity) getContext()).startActivityForResult(launchIntent, ApplicationConstants.RequestCodes.OSM_CAPTURE);
    ...
    public void setData(Object answer) {
        ...
        osmFileNameTextView.setText(osmFileName);
        osmFileNameHeaderTextView.setVisibility(VISIBLE);
        osmFileNameTextView.setVisibility(VISIBLE);
