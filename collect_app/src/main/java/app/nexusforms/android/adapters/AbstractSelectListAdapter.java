...
import static app.nexusforms.android.widgets.QuestionWidget.isRTL;
...
public abstract class AbstractSelectListAdapter extends RecyclerView.Adapter<AbstractSelectListAdapter.ViewHolder>
    ...
    abstract class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void addMediaFromChoice(AudioVideoImageTextLabel audioVideoImageTextLabel, int index, TextView textView, List<SelectChoice> items) {
            ...
            audioVideoImageTextLabel.setTag(FormMediaUtils.getClipID(prompt, item));
            ...
            String audioURI = FormMediaUtils.getPlayableAudioURI(prompt, item, referenceManager);
            try {
                if (imageURI != null) {
    ...
    public void playAudio(SelectChoice selectChoice) {
        audioHelper.stop();
        Clip clip = FormMediaUtils.getClip(prompt, selectChoice, referenceManager);
        if (clip != null) {
