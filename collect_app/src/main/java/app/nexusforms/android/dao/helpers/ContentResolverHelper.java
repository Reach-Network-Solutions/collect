...
package app.nexusforms.android.dao.helpers;
    ...
    public static String getFormPath(Uri uri) {
        ...
        try (Cursor c = getContentResolver().query(uri, null, null, null, null)) {
            if (c != null && c.getCount() == 1) {
                c.moveToFirst();
                formPath = new StoragePathProvider().getAbsoluteFormFilePath(c.getString(c.getColumnIndex(FormsProviderAPI.FormsColumns.FORM_FILE_PATH)));
            }
        }
        return formPath;
    }
