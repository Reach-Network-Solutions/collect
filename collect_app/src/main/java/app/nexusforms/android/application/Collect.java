...
import app.nexusforms.strings.LocalizedApplication;
    ...
    */
    ...
    private void fixGoogleBug154855417() {
        try {
            ...
            boolean hasFixedGoogleBug154855417 = metaSharedPreferences.getBoolean(MetaKeys.KEY_GOOGLE_BUG_154855417_FIXED);

            if (!hasFixedGoogleBug154855417) {
                File corruptedZoomTables = new File(getFilesDir(), "ZoomTables.data");
                corruptedZoomTables.delete();

                metaSharedPreferences.save(MetaKeys.KEY_GOOGLE_BUG_154855417_FIXED, true);
            }
