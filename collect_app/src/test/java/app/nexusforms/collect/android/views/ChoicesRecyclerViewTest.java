package app.nexusforms.collect.android.views;
...
import app.nexusforms.android.adapters.SelectOneListAdapter;
...
import app.nexusforms.android.views.ChoicesRecyclerView;
...
public class ChoicesRecyclerViewTest {
    ...
    public void setUp() throws InvalidReferenceException {
        ...
        RobolectricHelpers.populateRecyclerView(recyclerView);
