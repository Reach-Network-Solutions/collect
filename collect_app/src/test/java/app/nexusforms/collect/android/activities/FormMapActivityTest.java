package app.nexusforms.collect.android.activities;
...
import app.nexusforms.collect.android.geo.TestMapFragment;
...
import static app.nexusforms.collect.android.activities.FormMapViewModelTest.testInstances;
...
public class FormMapActivityTest {
    ...
    @Test public void tappingOnLayerMenu_opensLayerDialog() {
        ...
        MatcherAssert.assertThat(fragments, CoreMatchers.not(CoreMatchers.hasItem(isA(MapsPreferencesFragment.class))));
