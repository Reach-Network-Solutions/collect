package app.nexusforms.collect.android.configure.qr;
...
import app.nexusforms.android.configure.qr.QRCodeActivityResultDelegate;
import app.nexusforms.android.configure.qr.QRCodeDecoder;
import app.nexusforms.android.configure.qr.QRCodeMenuDelegate;
...
public class QRCodeActivityResultDelegateTest {
    ...
    public void forSelectPhoto_whenResultCancelled_doesNothing() {
        QRCodeActivityResultDelegate delegate = new QRCodeActivityResultDelegate(context, settingsImporter, fakeQRDecoder, analytics);
        delegate.onActivityResult(QRCodeMenuDelegate.SELECT_PHOTO, Activity.RESULT_CANCELED, new Intent());
    }
