...
import app.nexusforms.testshared.TempFiles;
...
public class ServerFormsDetailsFetcherTest {
    ...
    private final MediaFile mediaFile = new MediaFile("blah.txt", "md5:" + FileUtils.getMd5Hash(new ByteArrayInputStream("blah".getBytes())), "http://example.com/media-file");
    ...
    public void whenFormHasManifestUrl_returnsMediaFilesInDetails() throws Exception {
        ...
        MatcherAssert.assertThat(serverFormDetails.get(1).getManifest().getMediaFiles(), contains(mediaFile));
    }
