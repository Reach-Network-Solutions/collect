...
public class AuditConfigTest {
    ...
    public void testParameters() {
        ...
        Assert.assertEquals(LocationClient.Priority.PRIORITY_HIGH_ACCURACY, auditConfig.getLocationPriority());
    ...
    public void testPriorities() {
        ...
        Assert.assertEquals(LocationClient.Priority.PRIORITY_HIGH_ACCURACY, auditConfig.getLocationPriority());
        auditConfig = new AuditConfig.Builder().setMode("balanced").setLocationMinInterval(null).setLocationMaxAge(null).setIsTrackingChangesEnabled(false).setIsIdentifyUserEnabled(false).setIsTrackChangesReasonEnabled(false).createAuditConfig();
        Assert.assertEquals(LocationClient.Priority.PRIORITY_BALANCED_POWER_ACCURACY, auditConfig.getLocationPriority());
        auditConfig = new AuditConfig.Builder().setMode("BALANCED").setLocationMinInterval(null).setLocationMaxAge(null).setIsTrackingChangesEnabled(false).setIsIdentifyUserEnabled(false).setIsTrackChangesReasonEnabled(false).createAuditConfig();
        Assert.assertEquals(LocationClient.Priority.PRIORITY_BALANCED_POWER_ACCURACY, auditConfig.getLocationPriority());
        ...
        Assert.assertEquals(LocationClient.Priority.PRIORITY_LOW_POWER, auditConfig.getLocationPriority());
        ...
        Assert.assertEquals(LocationClient.Priority.PRIORITY_NO_POWER, auditConfig.getLocationPriority());
