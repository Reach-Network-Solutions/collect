...
import app.nexusforms.android.application.initialization.migration.KeyCombiner;
...
public class KeyCombinerTest {
    ...
    public void combinesValuesOfTwoKeys_andRemovesOldKeys() {
        ...
        MigrationUtils.combineKeys("red", "blue")
    ...
    public void canCombineMultipleValues() {
        KeyCombiner combiner = MigrationUtils.combineKeys("red", "blue")
    ...
    public void whenCombinedKeyExists_removesOtherKey_andModifiesExistingKey() {
        ...
        MigrationUtils.combineKeys("direction", "other-direction")
