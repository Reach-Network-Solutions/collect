package app.nexusforms.collect.android.audio;
...
import app.nexusforms.android.audio.BackgroundAudioHelpDialogFragment;
...
public class AudioRecordingControllerFragmentTest {
    ...
    public void whenFormHasBackgroundRecording_clickingHelpButton_opensHelpDialog() {
        ...
        scenario.onFragment(fragment -> {
            ...
            BackgroundAudioHelpDialogFragment dialog = RobolectricHelpers.getFragmentByClass(fragment.getParentFragmentManager(), BackgroundAudioHelpDialogFragment.class);
    ...
    public void whenThereIsAnErrorStartingRecording_showsErrorDialog() {
        ...
        scenario.onFragment(fragment -> {
            AudioRecordingErrorDialogFragment dialog = RobolectricHelpers.getFragmentByClass(fragment.getParentFragmentManager(), AudioRecordingErrorDialogFragment.class);
            assertThat(dialog, notNullValue());
        });
    }
