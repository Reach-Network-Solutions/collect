...
import app.nexusforms.android.formentry.audit.AuditConfig;
import app.nexusforms.android.formentry.audit.AuditEvent;
import app.nexusforms.android.formentry.audit.AuditEventLogger;
...
public class AuditEventLoggerTest {
    ...
    public void whenAuditConfigIsNull_doesntWriteEvents() {
        ...
        auditEventLogger.logEvent(AuditEvent.AuditEventType.END_OF_FORM, false, 0);
    ...
    public void usesMostAccurateLocationForEvents() {
        ...
        auditEventLogger.logEvent(AuditEvent.AuditEventType.END_OF_FORM, false, 1548156712000L);
    ...
    public void expiresLocationsOlderThan60Seconds() {
        ...
        auditEventLogger.logEvent(AuditEvent.AuditEventType.END_OF_FORM, false, 120 * 1000L);
        auditEventLogger.flush();
    ...
    public void isDuplicateOfLastAuditEventTest() {
        ...
        auditEventLogger.logEvent(AuditEvent.AuditEventType.LOCATION_PROVIDERS_ENABLED, false, 0);
        assertTrue(auditEventLogger.isDuplicateOfLastLocationEvent(AuditEvent.AuditEventType.LOCATION_PROVIDERS_ENABLED));
        auditEventLogger.logEvent(AuditEvent.AuditEventType.LOCATION_PROVIDERS_DISABLED, false, 0);
        assertTrue(auditEventLogger.isDuplicateOfLastLocationEvent(AuditEvent.AuditEventType.LOCATION_PROVIDERS_DISABLED));
        assertFalse(auditEventLogger.isDuplicateOfLastLocationEvent(AuditEvent.AuditEventType.LOCATION_PROVIDERS_ENABLED));
    ...
    public void logEvent_WithChangeReason_addsChangeReasonToEvent() {
        ...
        auditEventLogger.logEvent(AuditEvent.AuditEventType.CHANGE_REASON, null, false, null, 123L, "Blah");
        auditEventLogger.flush(); // Triggers event writing
    ...
    public void testEventTypes() {
        ...
        auditEventLogger.logEvent(AuditEvent.AuditEventType.BEGINNING_OF_FORM, false, 0); //shouldn't be logged
        auditEventLogger.logEvent(AuditEvent.AuditEventType.QUESTION, false, 0);
        auditEventLogger.logEvent(AuditEvent.AuditEventType.GROUP, false, 0);
        auditEventLogger.logEvent(AuditEvent.AuditEventType.PROMPT_NEW_REPEAT, false, 0);
        auditEventLogger.logEvent(AuditEvent.AuditEventType.REPEAT, false, 0); //shouldn't be logged
        auditEventLogger.logEvent(AuditEvent.AuditEventType.END_OF_FORM, false, 0);
        auditEventLogger.logEvent(AuditEvent.AuditEventType.FORM_START, false, 0);
        auditEventLogger.logEvent(AuditEvent.AuditEventType.FORM_RESUME, false, 0);
        auditEventLogger.logEvent(AuditEvent.AuditEventType.FORM_SAVE, false, 0);
        auditEventLogger.logEvent(AuditEvent.AuditEventType.FORM_FINALIZE, false, 0);
        auditEventLogger.logEvent(AuditEvent.AuditEventType.HIERARCHY, false, 0);
        auditEventLogger.logEvent(AuditEvent.AuditEventType.SAVE_ERROR, false, 0);
        auditEventLogger.logEvent(AuditEvent.AuditEventType.FINALIZE_ERROR, false, 0);
        auditEventLogger.logEvent(AuditEvent.AuditEventType.CONSTRAINT_ERROR, false, 0);
        auditEventLogger.logEvent(AuditEvent.AuditEventType.DELETE_REPEAT, false, 0);
        auditEventLogger.logEvent(AuditEvent.AuditEventType.GOOGLE_PLAY_SERVICES_NOT_AVAILABLE, false, 0);
        auditEventLogger.logEvent(AuditEvent.AuditEventType.LOCATION_PERMISSIONS_GRANTED, false, 0);
        auditEventLogger.logEvent(AuditEvent.AuditEventType.LOCATION_PERMISSIONS_NOT_GRANTED, false, 0);
        auditEventLogger.logEvent(AuditEvent.AuditEventType.LOCATION_TRACKING_ENABLED, false, 0);
        auditEventLogger.logEvent(AuditEvent.AuditEventType.LOCATION_TRACKING_DISABLED, false, 0);
        auditEventLogger.logEvent(AuditEvent.AuditEventType.LOCATION_PROVIDERS_ENABLED, false, 0);
        auditEventLogger.logEvent(AuditEvent.AuditEventType.LOCATION_PROVIDERS_DISABLED, false, 0);
        auditEventLogger.logEvent(AuditEvent.AuditEventType.UNKNOWN_EVENT_TYPE, false, 0);
