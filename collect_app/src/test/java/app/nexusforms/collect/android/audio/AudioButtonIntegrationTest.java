...
public class AudioButtonIntegrationTest {
    ...
    public void canPlayAndStopAudio() throws Exception {
        ...
        final DataSource dataSource = RobolectricHelpers.setupMediaPlayerDataSource(testFile);
    ...
    public void playingAudio_stopsOtherAudio() throws Exception {
        ...
        RobolectricHelpers.setupMediaPlayerDataSource(testFile1);
        final DataSource dataSource2 = RobolectricHelpers.setupMediaPlayerDataSource(testFile2);
