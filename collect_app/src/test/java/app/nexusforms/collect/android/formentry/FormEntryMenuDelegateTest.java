...
import app.nexusforms.shared.livedata.MutableNonNullLiveData;
...
import static app.nexusforms.collect.android.support.RobolectricHelpers.createThemedActivity;
...
public class FormEntryMenuDelegateTest {
    ...
    public void onItemSelected_whenAddRepeat_whenRecording_showsWarning() {
        ...
        RecordingWarningDialogFragment dialog = RobolectricHelpers.getFragmentByClass(activity.getSupportFragmentManager(), RecordingWarningDialogFragment.class);
    ...
    public void onItemSelected_whenPreferences_startsPreferencesActivityWithChangeSettingsRequest() {
        ...
        MatcherAssert.assertThat(nextStartedActivity.requestCode, Matchers.is(ApplicationConstants.RequestCodes.CHANGE_SETTINGS));
    }
