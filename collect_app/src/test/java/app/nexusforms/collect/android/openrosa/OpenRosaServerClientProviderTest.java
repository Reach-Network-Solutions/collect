...
import app.nexusforms.android.openrosa.HttpCredentials;
import app.nexusforms.android.openrosa.OpenRosaConstants;
import app.nexusforms.android.openrosa.OpenRosaServerClient;
import app.nexusforms.android.openrosa.OpenRosaServerClientProvider;
import app.nexusforms.collect.android.openrosa.support.MockWebServerRule;
...
import app.nexusforms.collect.android.openrosa.support.MockWebServerHelper;
...
public abstract class OpenRosaServerClientProviderTest {
    ...
    public void sendsDateHeader() throws Exception {
        ...
        OpenRosaServerClient client = subject.get("http", "Android", null);
        client.makeRequest(MockWebServerHelper.buildRequest(mockWebServer, ""), currentTime);
    ...
    public void withCredentials_onceBasicChallenged_whenHttps_proactivelySendsCredentials() throws Exception {
        ...
        OpenRosaServerClient client = subject.get("https", "Android", new HttpCredentials("user", "pass"));
        client.makeRequest(MockWebServerHelper.buildRequest(mockWebServer, ""), new Date());
        client.makeRequest(MockWebServerHelper.buildRequest(mockWebServer, "/different"), new Date());
    ...
    public void authenticationIsCachedBetweenInstances() throws Exception {
        ...
        subject.get("http", "Android", new HttpCredentials("user", "pass")).makeRequest(MockWebServerHelper.buildRequest(mockWebServer, ""), new Date());
        subject.get("http", "Android", new HttpCredentials("user", "pass")).makeRequest(MockWebServerHelper.buildRequest(mockWebServer, "/different"), new Date());
    ...
    public void whenUsingDifferentCredentials_authenticationIsNotCachedBetweenInstances() throws Exception {
        ...
        subject.get("http", "Android", new HttpCredentials("user", "pass")).makeRequest(MockWebServerHelper.buildRequest(mockWebServer, ""), new Date());
        subject.get("http", "Android", new HttpCredentials("new-user", "pass")).makeRequest(MockWebServerHelper.buildRequest(mockWebServer, "/different"), new Date());
    ...
    public void whenConnectingToDifferentHosts_authenticationIsNotCachedBetweenInstances() throws Exception {
        ...
        subject.get("http", "Android", new HttpCredentials("user", "pass")).makeRequest(MockWebServerHelper.buildRequest(host1, ""), new Date());
        subject.get("http", "Android", new HttpCredentials("user", "pass")).makeRequest(MockWebServerHelper.buildRequest(host2, ""), new Date());
