...
import app.nexusforms.android.widgets.RatingWidget;
...
public class RatingWidgetTest {
    ...
    public void usingReadOnly_makesAllClickableElementsDisabled() {
        RatingWidget widget = createWidget(QuestionWidgetHelpers.promptWithReadOnlyAndQuestionDef(rangeQuestion));
    ...
    public void getAnswer_whenPromptHasAnswer_returnsAnswer_forRatingBarInSingleLine() {
        RatingWidget widget = createWidget(QuestionWidgetHelpers.promptWithQuestionAndAnswer(rangeQuestion, new StringData("3")));
    ...
    public void getAnswer_whenPromptHasAnswer_returnsAnswer_forRatingBarInMultipleLines() {
        ...
        RatingWidget widget = createWidget(QuestionWidgetHelpers.promptWithQuestionAndAnswer(rangeQuestion, new StringData("7")));
    ...
    public void settingRatingOnTopRatingBar_deselectsAllStarsOnBottomRatingBar() {
        when(rangeQuestion.getRangeEnd()).thenReturn(BigDecimal.valueOf(10));
        RatingWidget widget = createWidget(QuestionWidgetHelpers.promptWithQuestionAndAnswer(rangeQuestion, null));
    ...
    public void whenUserTouchesTopRatingBar_bottomRatingBarShowsZeroRating() {
        when(rangeQuestion.getRangeEnd()).thenReturn(BigDecimal.valueOf(10));
        RatingWidget widget = createWidget(QuestionWidgetHelpers.promptWithQuestionAndAnswer(rangeQuestion, new StringData("8")));
    ...
    private RatingWidget createWidget(FormEntryPrompt prompt) {
        return new RatingWidget(QuestionWidgetHelpers.widgetTestActivity(), new QuestionDetails(prompt, "formAnalyticsID"));
    }
}
