...
import app.nexusforms.android.formentry.audit.AsyncTaskAuditEventWriter;
...
public class AsyncTaskAuditEventWriterTest {
    ...
    public void saveAuditWithChangeReason() throws Exception {
        ...
        writer.writeEvents(asList(
                new AuditEvent(1548108900606L, AuditEvent.AuditEventType.FORM_RESUME, null, null, null, null),
                new AuditEvent(1548108900606L, AuditEvent.AuditEventType.CHANGE_REASON, null, null, null, "A good reason")
        ));
    ...
    private List<AuditEvent> getSampleAuditEventsWithoutLocations() {
        ...
        auditEvents.add(new AuditEvent(1548106927319L, AuditEvent.AuditEventType.FORM_START));
        event = new AuditEvent(1548106927323L, AuditEvent.AuditEventType.QUESTION, getTestFormIndex("/data/q1"), "", null, null);
        event.setEnd(1548106930112L);
        auditEvents.add(event);
        event = new AuditEvent(1548106930118L, AuditEvent.AuditEventType.PROMPT_NEW_REPEAT, getTestFormIndex("/data/g1[1]"), "", null, null);
        event.setEnd(1548106931611L);
        auditEvents.add(event);
        event = new AuditEvent(1548106931612L, AuditEvent.AuditEventType.QUESTION, getTestFormIndex("/data/g1[1]/q2"), "", null, null);
        event.setEnd(1548106937122L);
        auditEvents.add(event);
        event = new AuditEvent(1548106937123L, AuditEvent.AuditEventType.PROMPT_NEW_REPEAT, getTestFormIndex("/data/g1[2]"), "", null, null);
        event.setEnd(1548106938276L);
        auditEvents.add(event);
        event = new AuditEvent(1548106938277L, AuditEvent.AuditEventType.QUESTION, getTestFormIndex("/data/g1[2]/q2"), "", null, null);
        event.setEnd(1548106948127L);
        auditEvents.add(event);
        event = new AuditEvent(1548106948128L, AuditEvent.AuditEventType.PROMPT_NEW_REPEAT, getTestFormIndex("/data/g1[3]"), "", null, null);
        event.setEnd(1548106949446L);
        auditEvents.add(event);
        event = new AuditEvent(1548106949448L, AuditEvent.AuditEventType.END_OF_FORM);
        event.setEnd(1548106953601L);
        auditEvents.add(event);
        auditEvents.add(new AuditEvent(1548106953600L, AuditEvent.AuditEventType.FORM_SAVE));
        auditEvents.add(new AuditEvent(1548106953601L, AuditEvent.AuditEventType.FORM_EXIT));
        auditEvents.add(new AuditEvent(1548106953601L, AuditEvent.AuditEventType.FORM_FINALIZE));
        return auditEvents;
    }
    ...
    private ArrayList<AuditEvent> getMoreSampleAuditEventsWithLocations() {
        AuditEvent event;
        ArrayList<AuditEvent> auditEvents = new ArrayList<>();
        event = new AuditEvent(1548108900606L, AuditEvent.AuditEventType.FORM_RESUME);
        event.setLocationCoordinates("54.4112062", "18.5896652", "30.716999053955078");
        auditEvents.add(event);
        event = new AuditEvent(1548108906276L, AuditEvent.AuditEventType.HIERARCHY);
        event.setLocationCoordinates("54.4112062", "18.5896652", "30.716999053955078");
        event.setEnd(1548108908206L);
        auditEvents.add(event);
        event = new AuditEvent(548108908250L, AuditEvent.AuditEventType.LOCATION_TRACKING_ENABLED);
        event.setLocationCoordinates("", "", "");
        auditEvents.add(event);
        event = new AuditEvent(548108908255L, AuditEvent.AuditEventType.LOCATION_PERMISSIONS_GRANTED);
        event.setLocationCoordinates("", "", "");
        auditEvents.add(event);
        event = new AuditEvent(548108908259L, AuditEvent.AuditEventType.LOCATION_PROVIDERS_ENABLED);
        event.setLocationCoordinates("", "", "");
        auditEvents.add(event);
        event = new AuditEvent(1548108908285L, AuditEvent.AuditEventType.END_OF_FORM);
        event.setLocationCoordinates("54.4112062", "18.5896652", "30.716999053955078");
        event.setEnd(1548108909730L);
        auditEvents.add(event);
        event = new AuditEvent(1548108909730L, AuditEvent.AuditEventType.FORM_SAVE);
        event.setLocationCoordinates("54.4112062", "18.5896652", "30.716999053955078");
        auditEvents.add(event);
        event = new AuditEvent(1548108909730L, AuditEvent.AuditEventType.FORM_EXIT);
        event.setLocationCoordinates("54.4112062", "18.5896652", "30.716999053955078");
        auditEvents.add(event);
        event = new AuditEvent(1548108909731L, AuditEvent.AuditEventType.FORM_FINALIZE);
        event.setLocationCoordinates("54.4112062", "18.5896652", "30.716999053955078");
        auditEvents.add(event);
        return auditEvents;
    }
    ...
    private ArrayList<AuditEvent> getMoreSampleAuditEventsWithLocationsAndTrackingChanges() {
        ...
        event.setLocationCoordinates("54.4112062", "18.5896652", "30.716999053955078");
        auditEvents.add(event);
        event = new AuditEvent(1548108900700L, AuditEvent.AuditEventType.QUESTION, null, "Old value", null, null);
        event.setLocationCoordinates("54.4112062", "18.5896652", "30.716999053955078");
        event.recordValueChange("New value");
        auditEvents.add(event);
        event = new AuditEvent(1548108903100L, AuditEvent.AuditEventType.QUESTION, null, "Old value, with comma", null, null);
        event.setLocationCoordinates("54.4112062", "18.5896652", "30.716999053955078");
        event.recordValueChange("New value");
        auditEvents.add(event);
        event = new AuditEvent(1548108903101L, AuditEvent.AuditEventType.QUESTION, null, "Old value \n with linebreak", null, null);
        event.setLocationCoordinates("54.4112062", "18.5896652", "30.716999053955078");
        event.recordValueChange("New value \n with linebreak and \"quotes\"");
        auditEvents.add(event);
        event = new AuditEvent(1548108904200L, AuditEvent.AuditEventType.QUESTION, null, "Old value", null, null);
        event.setLocationCoordinates("54.4112062", "18.5896652", "30.716999053955078");
    ...
    private ArrayList<AuditEvent> getSampleAuditEventsWithLocations() {
        ArrayList<AuditEvent> auditEvents = new ArrayList<>();
        AuditEvent event;
        event = new AuditEvent(1548106927319L, AuditEvent.AuditEventType.FORM_START);
        event.setLocationCoordinates("", "", "");
        auditEvents.add(event);
        event = new AuditEvent(548108908250L, AuditEvent.AuditEventType.LOCATION_TRACKING_ENABLED);
        event.setLocationCoordinates("", "", "");
        ...
        event.setEnd(1548106953601L);
        auditEvents.add(event);
        event = new AuditEvent(1548106953600L, AuditEvent.AuditEventType.FORM_SAVE);
        event.setLocationCoordinates("54.4112062", "18.5896652", "30.716999053955078");
        auditEvents.add(event);
        event = new AuditEvent(1548106953601L, AuditEvent.AuditEventType.FORM_EXIT);
        event.setLocationCoordinates("54.4112062", "18.5896652", "30.716999053955078");
        auditEvents.add(event);
        event = new AuditEvent(1548106953601L, AuditEvent.AuditEventType.FORM_FINALIZE);
        event.setLocationCoordinates("54.4112062", "18.5896652", "30.716999053955078");
        auditEvents.add(event);
        return auditEvents;
    }
    ...
    private ArrayList<AuditEvent> getSampleAuditEventsWithLocationsAndTrackingChanges() {
        ...
        event.setLocationCoordinates("", "", "");
        auditEvents.add(event);
        event = new AuditEvent(1548106927323L, AuditEvent.AuditEventType.QUESTION, getTestFormIndex("/data/q1"), "Old value", null, null);
        event.setLocationCoordinates("54.4112062", "18.5896652", "30.716999053955078");
        event.recordValueChange("New Value");
        event.setEnd(1548106930112L);
        auditEvents.add(event);
        event = new AuditEvent(1548106930118L, AuditEvent.AuditEventType.PROMPT_NEW_REPEAT, getTestFormIndex("/data/g1[1]"), null, null, null);
        event.setLocationCoordinates("54.4112062", "18.5896652", "30.716999053955078");
        event.setEnd(1548106931611L);
        auditEvents.add(event);
        event = new AuditEvent(1548106949448L, AuditEvent.AuditEventType.END_OF_FORM, null, null, null, null);
        event.setLocationCoordinates("54.4112062", "18.5896652", "30.716999053955078");
        event.setEnd(1548106953601L);
        auditEvents.add(event);
        event = new AuditEvent(1548106953600L, AuditEvent.AuditEventType.FORM_SAVE, null, null, null, null);
        event.setLocationCoordinates("54.4112062", "18.5896652", "30.716999053955078");
        auditEvents.add(event);
        event = new AuditEvent(1548106953601L, AuditEvent.AuditEventType.FORM_EXIT, null, null, null, null);
        event.setLocationCoordinates("54.4112062", "18.5896652", "30.716999053955078");
        auditEvents.add(event);
        event = new AuditEvent(1548106953601L, AuditEvent.AuditEventType.FORM_FINALIZE, null, null, null, null);
        event.setLocationCoordinates("54.4112062", "18.5896652", "30.716999053955078");
        auditEvents.add(event);
        return auditEvents;
    }
