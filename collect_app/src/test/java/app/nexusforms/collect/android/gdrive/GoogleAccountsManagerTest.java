package app.nexusforms.collect.android.gdrive;
...
public class GoogleAccountsManagerTest {
    ...
    @Before
    public void setup() {
        googleAccountsManager = Mockito.spy(new GoogleAccountsManager(mockedCredential, settingsProvider, mockIntent, mockThemeUtils));
