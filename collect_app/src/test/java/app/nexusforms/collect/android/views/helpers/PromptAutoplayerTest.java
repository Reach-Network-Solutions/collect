package app.nexusforms.collect.android.views.helpers;
...
import app.nexusforms.android.formentry.media.PromptAutoplayer;
import app.nexusforms.collect.android.support.MockFormEntryPromptBuilder;
import org.odk.collect.audioclips.Clip;

import java.util.List;

import app.nexusforms.collect.android.support.CollectHelpers;
...
import static app.nexusforms.android.utilities.Appearances.COMPACT;
import static app.nexusforms.android.utilities.Appearances.MINIMAL;
import static app.nexusforms.android.utilities.Appearances.NO_BUTTONS;
...
public class PromptAutoplayerTest {
    ...
    public void setup() throws Exception {
        ReferenceManager referenceManager = CollectHelpers.setupFakeReferenceManager(REFERENCES);
