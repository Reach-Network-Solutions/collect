...
public class ThemeUtilsTests {
    ...
    private void applyDarkTheme() {
        generalSettings.save(GeneralKeys.KEY_APP_THEME, mainMenuActivity.getString(R.string.app_theme_dark));
    }

    private void applyLightTheme() {
        generalSettings.save(GeneralKeys.KEY_APP_THEME, mainMenuActivity.getString(R.string.app_theme_light));
    }
}
