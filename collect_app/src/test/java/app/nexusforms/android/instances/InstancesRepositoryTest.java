...
package app.nexusforms.android.instances;

import org.junit.Test;

import java.util.List;

import app.nexusforms.android.support.InstanceUtils;
...
import static app.nexusforms.android.support.InstanceUtils.buildInstance;
...
public abstract class InstancesRepositoryTest {
    ...
    public void getAllNotDeleted_returnsUndeletedInstances() {
        ...
        instancesRepository.save(InstanceUtils.buildInstance("deleted", "1")
                .status(Instance.STATUS_COMPLETE)
                .deletedDate(System.currentTimeMillis())
                .build());
        instancesRepository.save(InstanceUtils.buildInstance("undeleted", "1")
                .status(Instance.STATUS_COMPLETE)
                .build());
    ...
    public void getAllByStatus_withOneStatus_returnsMatchingInstances() {
        ...
        instancesRepository.save(InstanceUtils.buildInstance("incomplete", "1")
        ...
        instancesRepository.save(InstanceUtils.buildInstance("complete", "1")
                .status(Instance.STATUS_COMPLETE)
                .build());
        instancesRepository.save(InstanceUtils.buildInstance("complete", "1")
                .status(Instance.STATUS_COMPLETE)
    ...
    public void getAllByStatus_withMultipleStatus_returnsMatchingInstances() {
        ...
        instancesRepository.save(InstanceUtils.buildInstance("submitted", "1")
    ...
    public void getAllByFormId_includesAllVersionsForFormId() {
        ...
        instancesRepository.save(InstanceUtils.buildInstance("formid", "1").build());
        instancesRepository.save(InstanceUtils.buildInstance("formid", "2", "display", Instance.STATUS_COMPLETE, null).build());
        instancesRepository.save(InstanceUtils.buildInstance("formid", "3").build());
        instancesRepository.save(InstanceUtils.buildInstance("formid", "4", "display", Instance.STATUS_COMPLETE, System.currentTimeMillis()).build());
        instancesRepository.save(InstanceUtils.buildInstance("formid2", "1", "display", Instance.STATUS_COMPLETE, null).build());
    ...
    public void getAllByFormIdAndVersionNotDeleted_excludesDeleted() {
        ...
        instancesRepository.save(InstanceUtils.buildInstance("formid", "1").build());
        instancesRepository.save(InstanceUtils.buildInstance("formid", "1", "display", Instance.STATUS_COMPLETE, null)
                .build());
        instancesRepository.save(InstanceUtils.buildInstance("formid", "1").build());
        instancesRepository.save(InstanceUtils.buildInstance("formid", "1", "display", Instance.STATUS_COMPLETE, System.currentTimeMillis())
                .build());
        instancesRepository.save(InstanceUtils.buildInstance("formid2", "1", "display", Instance.STATUS_COMPLETE, null)
                .build());
    ...
    public void save_returnsInstanceWithId() {
        ...
        Instance instance = instancesRepository.save(InstanceUtils.buildInstance("formid", "1").build());
    ...
    public void save_whenInstanceHasId_updatesExisting() {
        ...
        Instance originalInstance = instancesRepository.save(InstanceUtils.buildInstance("formid", "1")
                .displayName("Blah")
                .build());
    ...
    public void save_whenStatusIsNull_usesIncomplete() {
        ...
        Instance instance = instancesRepository.save(InstanceUtils.buildInstance("formid", "1")
                .status(null)
                .build());
