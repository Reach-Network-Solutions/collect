...
import app.nexusforms.android.support.FormUtils;
...
import static app.nexusforms.android.support.FormUtils.buildForm;
...
public abstract class FormsRepositoryTest {
    ...
    public void getLatestByFormIdAndVersion_whenFormHasNullVersion_returnsForm() {
        ...
        formsRepository.save(app.nexusforms.android.support.FormUtils.buildForm("1", null, getFormFilesPath())
                .build());
    ...
    public void getLatestByFormIdAndVersion_whenMultipleExist_returnsLatest() {
        ...
        formsRepository.save(app.nexusforms.android.support.FormUtils.buildForm("1", "1", getFormFilesPath())
                .build());
        formsRepository.save(app.nexusforms.android.support.FormUtils.buildForm("1", "1", getFormFilesPath())
                .build());
        formsRepository.save(app.nexusforms.android.support.FormUtils.buildForm("1", "1", getFormFilesPath())
    ...
    public void getAllByFormIdAndVersion_whenFormHasNullVersion_returnsAllMatchingForms() {
        ...
        formsRepository.save(app.nexusforms.android.support.FormUtils.buildForm("1", "7", getFormFilesPath())
                .build());
    ...
    public void getAllNotDeletedByFormId_doesNotReturnDeletedForms() {
        FormsRepository formsRepository = buildSubject();
        formsRepository.save(app.nexusforms.android.support.FormUtils.buildForm("1", "deleted", getFormFilesPath())
                .deleted(true)
                .build()
        );

        formsRepository.save(app.nexusforms.android.support.FormUtils.buildForm("1", "not-deleted", getFormFilesPath())
                .deleted(false)
                .build()
        );
    ...
    public void getAllNotDeletedByFormIdAndVersion_onlyReturnsNotDeletedFormsThatMatchVersion() {
        FormsRepository formsRepository = buildSubject();
        formsRepository.save(app.nexusforms.android.support.FormUtils.buildForm("id", "1", getFormFilesPath())
                .deleted(true)
                .build()
        );
        formsRepository.save(app.nexusforms.android.support.FormUtils.buildForm("id", "1", getFormFilesPath())
        ...
        formsRepository.save(app.nexusforms.android.support.FormUtils.buildForm("id", "2", getFormFilesPath())
                .deleted(true)
                .build()
        );
        formsRepository.save(app.nexusforms.android.support.FormUtils.buildForm("id", "2", getFormFilesPath())
    ...
    public void save_addsId() {
        FormsRepository formsRepository = buildSubject();
        Form form = app.nexusforms.android.support.FormUtils.buildForm("id", "version", getFormFilesPath()).build();
    ...
    public void save_whenFormHasId_updatesExisting() {
        FormsRepository formsRepository = buildSubject();
        Form originalForm = formsRepository.save(app.nexusforms.android.support.FormUtils.buildForm("id", "version", getFormFilesPath())
    ...
    public void delete_deletesFiles() {
        FormsRepository formsRepository = buildSubject();
        Form form = formsRepository.save(app.nexusforms.android.support.FormUtils.buildForm("id", "version", getFormFilesPath()).build());
    ...
    public void deleteAll_deletesAllForms() {
        FormsRepository formsRepository = buildSubject();
        formsRepository.save(app.nexusforms.android.support.FormUtils.buildForm("id1", "version", getFormFilesPath()).build());
        formsRepository.save(app.nexusforms.android.support.FormUtils.buildForm("id2", "version", getFormFilesPath()).build());
    ...
    public void getOneByMd5Hash_returnsMatchingForm() {
        FormsRepository formsRepository = buildSubject();
        formsRepository.save(app.nexusforms.android.support.FormUtils.buildForm("id1", "version", getFormFilesPath()).build());
        Form form2 = formsRepository.save(app.nexusforms.android.support.FormUtils.buildForm("id2", "version", getFormFilesPath()).build());
    ...
    public void getOneByPath_returnsMatchingForm() {
        ...
        Form form2 = app.nexusforms.android.support.FormUtils.buildForm("id2", "version", getFormFilesPath()).build();
    ...
    public void getAllFormId_returnsMatchingForms() {
        FormsRepository formsRepository = buildSubject();
        Form form1 = formsRepository.save(app.nexusforms.android.support.FormUtils.buildForm("id1", "version", getFormFilesPath()).build());
        Form form2 = formsRepository.save(app.nexusforms.android.support.FormUtils.buildForm("id1", "other_version", getFormFilesPath()).build());
        ...
        assertThat(forms.size(), is(2));
        assertThat(forms, Matchers.contains(form1, form2));
    }
}
