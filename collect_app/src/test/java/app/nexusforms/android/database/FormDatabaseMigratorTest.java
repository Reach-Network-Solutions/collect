...
import app.nexusforms.android.database.FormDatabaseMigrator;
...
import static app.nexusforms.android.provider.FormsProviderAPI.FormsColumns.AUTO_DELETE;
import static app.nexusforms.android.provider.FormsProviderAPI.FormsColumns.AUTO_SEND;
import static app.nexusforms.android.provider.FormsProviderAPI.FormsColumns.BASE64_RSA_PUBLIC_KEY;
import static app.nexusforms.android.provider.FormsProviderAPI.FormsColumns.DATE;
import static app.nexusforms.android.provider.FormsProviderAPI.FormsColumns.DELETED_DATE;
import static app.nexusforms.android.provider.FormsProviderAPI.FormsColumns.DESCRIPTION;
import static app.nexusforms.android.provider.FormsProviderAPI.FormsColumns.DISPLAY_NAME;
import static app.nexusforms.android.provider.FormsProviderAPI.FormsColumns.FORM_FILE_PATH;
import static app.nexusforms.android.provider.FormsProviderAPI.FormsColumns.FORM_MEDIA_PATH;
import static app.nexusforms.android.provider.FormsProviderAPI.FormsColumns.GEOMETRY_XPATH;
import static app.nexusforms.android.provider.FormsProviderAPI.FormsColumns.JRCACHE_FILE_PATH;
import static app.nexusforms.android.provider.FormsProviderAPI.FormsColumns.JR_FORM_ID;
import static app.nexusforms.android.provider.FormsProviderAPI.FormsColumns.JR_VERSION;
import static app.nexusforms.android.provider.FormsProviderAPI.FormsColumns.LANGUAGE;
import static app.nexusforms.android.provider.FormsProviderAPI.FormsColumns.MD5_HASH;
import static app.nexusforms.android.provider.FormsProviderAPI.FormsColumns.SUBMISSION_URI;
import static app.nexusforms.android.provider.FormsProviderAPI.FormsColumns._ID;
