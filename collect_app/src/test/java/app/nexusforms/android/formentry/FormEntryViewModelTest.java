...
public class FormEntryViewModelTest {
    ...
    public void addRepeat_whenThereIsAnErrorCreatingRepeat_setsErrorWithMessage() {
        ...
        viewModel.addRepeat();
        assertThat(viewModel.getError().getValue(), equalTo(new FormEntryViewModel.NonFatal("OH NO")));
    }
    ...
    public void addRepeat_whenThereIsAnErrorCreatingRepeat_setsErrorWithoutCause() {
        ...
        viewModel.addRepeat();
        assertThat(viewModel.getError().getValue(), equalTo(new FormEntryViewModel.NonFatal("Unknown issue occurred while adding a new group")));
    }
