...
public class ExternalAppUtilsTest {
    ...
    public void extractIntentNameTest() {
        Assert.assertEquals("org.opendatakit.counter", ExternalAppsUtils.extractIntentName("org.opendatakit.counter(form_id='counter-form', form_name='Counter Form', question_id='1', question_name='Counter 1', increment=true())"));
